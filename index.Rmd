...
<style>
  .profile-img {
    ...
    margin: 0px 20px;
    float: left; /* align="left" 대신 사용 */
  }
</style>

<div class="jumbotron">
    <img src="jung2024s.jpg" class="profile-img">
    <div class="container">
      ...
      <p><a class="btn btn-primary btn-lg" href="pubs.html" role="button">Publications</a>
